...
HTML_PATH = "C://Users//michele.belotti//Development//my//patente_2//data//pat_base.html"
# Leggi il contenuto del file HTML
with open(HTML_PATH, "r", encoding="utf-8") as file:
    html_content = file.read()

keys=["id", "img", "question", "anwser_1", "tf1", "anwser_2", "tf2", "anwser_3", "tf3"]
...
def save_to_json(data, filename="C://Users//michele.belotti//Development//my//patente_2//data//all_data2.json"):
